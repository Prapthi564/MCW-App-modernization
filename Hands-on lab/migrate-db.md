...
1. Launch DMA from the Windows. click on  **Start** menu. Start typing **"data migration" (1)** into the search bar, and then selecting **Microsoft Data Migration Assistant (2)** from the search results.
